...
const ProductCard = ({
    ...
    const [selelectedViewProduct, setSelectedViewProduct] = useState("");
            ...
            <div className="p-4">
                ...
                {!about &&  (<div className="flex items-center justify-between">
                    ...
                    <button
                        ...
                        className={`bg-black ${isAvailable ? "opacity-100 hover:bg-[#333]" : "opacity-70"}
    text-white py-2 px-3 rounded-lg items-center transition-colors duration-300 w-36 flex justify-center`}
>
                        <FaShoppingCart className="mr-2" />
                        {isAvailable ? "加入購物車" : "缺貨中"}
                    </button>
                </div>
            )}
